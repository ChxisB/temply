...
const SWATCHES = ['#111827', '#374151', '#4f46e5', '#dc2626', '#059669', '#d97706', '#ffffff'];
              ...
              <div className="flex flex-1 gap-2">
                {SWATCHES.map((hex) => (
                  <button
                    ...
                    className={cn('size-9 rounded-full border border-line', color.toLowerCase() === hex && 'ring-[3px] ring-accent/40')}
