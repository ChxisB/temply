    ...
    <div className="mly:isolate mly:flex mly:rounded-lg">
      ...
      {isEditing && (
        <InputAutocomplete
          ...
          className="mly:h-7 mly:w-40 mly:rounded-md mly:px-2 mly:pr-6 mly:text-sm mly:text-midnight-gray mly:transition-colors mly:hover:bg-soft-gray mly:focus:bg-soft-gray mly:focus:outline-hidden"
