      ...
      >
        <div className="mly:min-w-[260px] mly:rounded-xl mly:border mly:border-gray-200 mly:bg-panel mly:p-4">
          ...
          <HexColorInput
            ...
            color={color}
            onChange={handleColorChange}
            className="mly:mt-4 mly:w-full mly:min-w-0 mly:rounded-lg mly:border mly:border-gray-200 mly:bg-panel mly:px-2 mly:py-1.5 mly:text-sm mly:uppercase mly:focus-visible:border-gray-400 mly:focus-visible:outline-hidden"
            prefixed
          />
