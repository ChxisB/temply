    ...
    <div className={cn('mly:relative')} ref={containerRef}>
      <label className="mly:relative">
        <input
          ...
          className={cn(
            'mly:h-7 mly:w-40 mly:rounded-md mly:bg-panel mly:px-2 mly:pr-6 mly:text-sm mly:text-midnight-gray mly:hover:bg-soft-gray mly:focus:bg-soft-gray mly:focus:outline-hidden',
            className
          )}
          onKeyDown={(e) => {
