  ...
  const content = (
    <div className="mly:relative">
      ...
      <select
        id={selectId}
        className={cn(
          'mly:flex mly:min-h-7 mly:max-w-max mly:appearance-none mly:items-center mly:rounded-md mly:bg-panel mly:px-1.5 mly:py-0.5 mly:pr-7 mly:text-sm mly:text-midnight-gray mly:transition-colors mly:hover:bg-soft-gray mly:focus-visible:relative mly:focus-visible:z-10 mly:active:bg-soft-gray',
          !!Icon && 'mly:pl-7',
          className
        )}
        value={value || ''}
